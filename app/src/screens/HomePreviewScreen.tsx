/**
 * HomePreviewScreen — dev-only preview of the auto-generated Home UI
 * from Home.spec.json.
 */
...
const STATES = ['H0', 'H1'] as const;
type S = (typeof STATES)[number];

export function HomePreviewScreen() {
  const nav = useNavigation<Nav>();
  const route = useRoute<RouteProp<RootStackParamList, 'HomePreview'>>();
  ...
  return (
    <View style={styles.root}>
      <View style={styles.phoneFrame}>
        <GeneratedHome state={state} initial={'F'} />
      </View>
