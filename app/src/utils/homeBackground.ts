...
const HOME_BG_ASSETS = {
  ...BG_ASSETS,
  'sunny-day': require('../../assets/home/prototypes/final-nz-world-sunny/final-micro-polish/sunny-day-systemic-unification-v2-3x.jpg'),
...
const ASSET_IDS: Record<HomeBgVariant, string> = {
  'sunny-day': 'sunny-day-systemic-unification-v2-3x.jpg',
